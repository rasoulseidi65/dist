...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
  ...
  function srcAppAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var primeng_password__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(primeng_password__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */
    ...
    var primeng_keyfilter__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(primeng_keyfilter__WEBPACK_IMPORTED_MODULE_11__);
    /* harmony import */
    ...
    var primeng_message__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(primeng_message__WEBPACK_IMPORTED_MODULE_12__);
    /* harmony import */
    ...
    AuthModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _auth_routing_module__WEBPACK_IMPORTED_MODULE_3__["AuthRoutingModule"], _layout_layout_module__WEBPACK_IMPORTED_MODULE_6__["LayoutModule"], primeng_password__WEBPACK_IMPORTED_MODULE_7__["PasswordModule"], primeng_button__WEBPACK_IMPORTED_MODULE_8__["ButtonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], primeng_toast__WEBPACK_IMPORTED_MODULE_10__["ToastModule"], primeng_keyfilter__WEBPACK_IMPORTED_MODULE_11__["KeyFilterModule"], primeng_message__WEBPACK_IMPORTED_MODULE_12__["MessageModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_13__["RadioButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_14__["MatRadioModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"], primeng_primeng__WEBPACK_IMPORTED_MODULE_13__["CaptchaModule"]]
    })], AuthModule);
    /***/
  },
  ...
  function srcAppAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _localStorageLogin_local_storage_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../localStorageLogin/local-storage.service */
    "./src/app/auth/localStorageLogin/local-storage.service.ts");

    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(fb, messageService, UserService, router, localstorage) {
        ...
        value: function onSubmit(value) {
          ...
          this.UserService.login(this.userform.value).subscribe(function (response) {
            ...
            if (response['success'] === true) {
              ...
              _this.localstorage.saveCurrentUser(JSON.stringify(data));
  ...
  function srcAppAuthRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _localStorageLogin_local_storage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../localStorageLogin/local-storage.service */
    "./src/app/auth/localStorageLogin/local-storage.service.ts");
    /* harmony import */
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(fb, messageService, UsersService, localstorage, router) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onSubmit(value) {
          ...
          this.submitted = true;
          this.UsersService.register(this.userform.value).subscribe(function (response) {
            if (response['success'] === true) {
              var data = response['data'];

              _this2.localstorage.saveCurrentUser(JSON.stringify(data));

              _this2.router.navigate(['/']);

              _this2.messageService.add({
                severity: 'success',
                summary: 'ثبت با موفقیت',
                detail: 'کاربر مشخصات با موفقیت ثبت شد'
              });
            } else {
              _this2.messageService.add({
                severity: 'error',
